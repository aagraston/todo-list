...
function addTaskToList() {
  ...
  const formInfo = htmlUpdater.getFormInfo()
  // create a task in the current project with this information
  projManager
    .getCurrentFocus()
    .createNewTask(formInfo.title, formInfo.date, formInfo.priority)
...
function addProjectToList() {
  const formInfo = htmlUpdater.getProjectTitle()
...
function listenForTaskRemoval() {
  const removalButtons = document.querySelectorAll('.removal')
